package com.laby.framework.ratelimiter.config;

import com.laby.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.laby.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.laby.framework.ratelimiter.core.keyresolver.impl.*;
...
public class LabyRateLimiterConfiguration {
