...
public class AiKnowledgeSaveReqVO {
    ...
    @Schema(description = "topK", requiredMode = Schema.RequiredMode.REQUIRED, example = "8")
    @NotNull(message = "topK 不能为空")
    private Integer topK;

    @Schema(description = "相似性阈值", requiredMode = Schema.RequiredMode.REQUIRED, example = "0.6")
    @NotNull(message = "相似性阈值不能为空")
    @DecimalMax(value = "0.85", message = "相似性阈值不能超过 0.85")
