package com.laby.module.ai.controller.admin.model;
...
import com.laby.module.ai.controller.admin.model.vo.chatRole.AiChatRoleRespVO;
...
public class AiChatRoleController {
    ...
    @PostMapping("/polish")
    @Operation(summary = "AI 润色角色设定（提示词）")
    @PreAuthorize("@ss.hasPermission('ai:chat-role:update')")
    public CommonResult<AiChatRolePolishRespVO> polishSystemMessage(
            @Valid @RequestBody AiChatRolePolishReqVO reqVO) {
        return success(chatRoleService.polishSystemMessage(reqVO));
    }
