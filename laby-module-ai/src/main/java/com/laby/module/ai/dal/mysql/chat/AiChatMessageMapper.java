package com.laby.module.ai.dal.mysql.chat;
...
public interface AiChatMessageMapper extends BaseMapperX<AiChatMessageDO> {
    ...
    default boolean existsSummaryContent(Long conversationId, String content) {
        return selectCount(new LambdaQueryWrapperX<AiChatMessageDO>()
                .eq(AiChatMessageDO::getConversationId, conversationId)
                .eq(AiChatMessageDO::getType, "summary")
                .eq(AiChatMessageDO::getContent, content)) > 0;
    }
