package com.laby.module.ai.tool.method;
...
public class PersonServiceImpl implements PersonService {
    ...
    public Person createPerson(@ToolParam(name = "personData", description = "New person data (ID is ignored)") Person personData) {
        if (personData == null) {
    ...
    public Optional<Person> getPersonById(@ToolParam(name = "id", description = "Person ID") int id) {
    ...
    public boolean updatePerson(@ToolParam(name = "id", description = "Person ID") int id,
                                @ToolParam(name = "updatedPersonData", description = "Updated person data (ID is ignored)") Person updatedPersonData) {
    ...
    public boolean deletePerson(@ToolParam(name = "id", description = "Person ID") int id) {
    ...
    public List<Person> searchByJobTitle(@ToolParam(name = "jobTitleQuery", description = "Job title search query") String jobTitleQuery) {
    ...
    public List<Person> filterBySex(@ToolParam(name = "sex", description = "Sex filter, e.g. Male or Female") String sex) {
    ...
    public List<Person> filterByAge(@ToolParam(name = "age", description = "Age filter") int age) {
         if (age < 0) {
