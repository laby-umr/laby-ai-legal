package com.laby.module.bpm.service.task;
...
import com.laby.framework.common.util.object.PageUtils;
...
import com.laby.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.laby.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.laby.module.bpm.controller.admin.task.vo.instance.*;
import com.laby.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.laby.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.laby.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.laby.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.laby.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.laby.module.bpm.enums.ErrorCodeConstants;
import com.laby.module.bpm.enums.definition.BpmModelTypeEnum;
import com.laby.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.laby.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.laby.module.bpm.enums.task.BpmReasonEnum;
import com.laby.module.bpm.enums.task.BpmTaskStatusEnum;
import com.laby.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.laby.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.laby.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.laby.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.laby.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.laby.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.laby.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.laby.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.laby.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.laby.module.bpm.service.definition.BpmProcessDefinitionService;
import com.laby.module.bpm.service.message.BpmMessageService;
import com.laby.module.system.api.dept.DeptApi;
...
import static com.laby.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.laby.module.bpm.enums.ErrorCodeConstants.*;
import static com.laby.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.laby.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    public BpmProcessInstanceBpmnModelViewRespVO getProcessInstanceBpmnModelView(String id) {
        ...
        // 补全：开始节点、网关分支连线等可能未写入历史，按活动顺序 + 流程变量推断高亮
        Map<String, Object> highlightVariables = new HashMap<>();
        if (CollUtil.isNotEmpty(processInstance.getProcessVariables())) {
            highlightVariables.putAll(processInstance.getProcessVariables());
        }
        BpmnModelUtils.supplementProcessHighlight(bpmnModel, activities, highlightVariables,
                finishedTaskActivityIds, unfinishedTaskActivityIds, finishedSequenceFlowActivityIds);
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/laby-cloud/issues/ID1UYA
