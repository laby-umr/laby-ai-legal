...
const AI_DICT = {
  ...
  AI_KNOWLEDGE_DOCUMENT_INGEST_STATUS: 'ai_knowledge_document_ingest_status', // 知识库文档入库状态
  AI_KNOWLEDGE_DOCUMENT_TYPE: 'ai_knowledge_document_type', // 知识库文档类型
  AI_KNOWLEDGE_PARSE_ENGINE: 'ai_knowledge_parse_engine', // 知识库解析引擎
  AI_KNOWLEDGE_SEGMENT_BLOCK_TYPE: 'ai_knowledge_segment_block_type', // 知识库分片块类型
  AI_KNOWLEDGE_SEGMENT_CHUNK_LEVEL: 'ai_knowledge_segment_chunk_level', // 知识库分片层级
} as const;
...
/** ========== LEGAL - 法务合同模块 ========== */
const LEGAL_DICT = {
  LEGAL_AI_TRACE_STATUS: 'legal_ai_trace_status',
  LEGAL_AUDIT_LEVEL: 'legal_audit_level',
  LEGAL_CLAUSE_TYPE: 'legal_clause_type',
  LEGAL_CONTRACT_SOURCE_FORMAT: 'legal_contract_source_format',
  LEGAL_CONTRACT_STATUS: 'legal_contract_status',
  LEGAL_PARTY_ROLE: 'legal_party_role',
  LEGAL_RISK_LEVEL: 'legal_risk_level',
  LEGAL_SKILL_PACK_SCENE: 'legal_skill_pack_scene',
  LEGAL_STANDARD_CLAUSE_SCOPE: 'legal_standard_clause_scope',
} as const;
