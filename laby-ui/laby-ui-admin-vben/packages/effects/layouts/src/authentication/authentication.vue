    ...
    <div v-if="!authPanelCenter" class="relative hidden w-0 flex-1 lg:block">
      ...
      >
        ...
        <div
          ...
          class="flex h-full w-full flex-col items-center justify-center px-8 xl:px-14"
          :class="{
        ...
        >
          ...
          <div
            class="text-1xl mt-4 max-w-[520px] text-center font-sans text-foreground lg:text-2xl"
          >
            {{ pageTitle }}
          </div>
          <div class="mt-2 max-w-[520px] text-center dark:text-muted-foreground">
            {{ pageDescription }}
          </div>
        </div>
      </div>
